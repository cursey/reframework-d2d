...
function()
    ...
    d2d.fill_circle(600, 500, 50, 50, 0xFF00FFFF)
    d2d.fill_circle(700, 500, 50, 80, 0xFF00FFFF)

    -- x, y, radius x, radius y, thickness, color
    d2d.circle(800, 500, 50, 50, 5, 0xFF00FFFF)
    d2d.circle(900, 500, 50, 80, 5, 0xFF00FFFF)
